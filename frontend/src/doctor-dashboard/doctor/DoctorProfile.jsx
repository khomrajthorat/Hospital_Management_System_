...
function DoctorProfile() {
  ...
  const letter = form.name?.trim()?.charAt(0)?.toUpperCase() || "D";
              ...
              <div className="card-body p-4">
                ...
                <form onSubmit={updateProfile} className="row g-3">
                  ...
                  <div className="col-12 mt-3">
                    <h6 className="fw-semibold">Professional details</h6>
                  </div>
                  ...
                  <div className="col-md-6">
                    <label className="small mb-1">Experience (years)</label>
                    <input
