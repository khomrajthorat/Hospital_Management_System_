...
export default function DoctorPatients() {
  ...
  const toggleStatus = async (patient) => {
    ...
    setPatients((prev) =>
      prev.map((p) =>
        (p._id || p.id) === id ? { ...p, isActive: newActive } : p
      )
    );
      ...
      <div className="container-fluid py-4">
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-between mb-4 gap-3">
          ...
          <div className="d-flex gap-2 w-100 w-md-auto">
            <button
              className="btn btn-outline-primary flex-grow-1 flex-md-grow-0 d-flex align-items-center justify-content-center gap-2"
              onClick={() => {
            ...
            <button
              className="btn btn-primary flex-grow-1 flex-md-grow-0 d-flex align-items-center justify-content-center gap-2"
              onClick={() => navigate("/doctor/AddPatient")}
            >
                      ...
                      return (
                        <tr key={id ?? idx} className="bg-white">
                          ...
                          <td className="text-center">
                            <div className="d-flex justify-content-center gap-2">
                              <button
                                ...
                                onClick={() =>
                                  navigate(`/doctor/EditPatient/${id}`)
                                }
                              >
                                <FaPen />
                              </button>
                          ...
                          <td className="mobile-card-view">
                            ...
                            {/* Card Details: Grid Layout (Corrected Alignment) */}
                            <div className="row g-2 mb-3">
                              ...
                              <div className="col-6 text-start">
                                ...
                                <div className="d-flex align-items-center justify-content-mid gap-2">
                                  <FaPhone
                              ...
                              {/* Clinic: Right Aligned (Matches Screenshot) */}
                            ...
                            <div className="d-flex justify-content-between align-items-center pt-2 border-top">
                              <div className="d-flex gap-3">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/doctor/appointments?patient=${id}`
                                    )
                                  }
                                >
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(`/doctor/billing?patient=${id}`)
                                  }
                                >
