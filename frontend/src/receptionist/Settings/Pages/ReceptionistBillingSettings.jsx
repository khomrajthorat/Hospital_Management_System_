// frontend/src/clinic-dashboard/clinic/settings/pages/ReceptionistBillingSettings.jsx
...
const ReceptionistBillingSettings = () => {
...
export default ReceptionistBillingSettings;
