...
// REMOVE THIS: import AdminLayout from "../admin-dashboard/layouts/AdminLayout";
...
// ADD PROPS HERE: { sidebarCollapsed, toggleSidebar }
const ReceptionistAddBill = ({ sidebarCollapsed, toggleSidebar }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const token = localStorage.getItem("token") || localStorage.getItem("receptionistToken"); // Ensure receptionist token is checked
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Fix: Ensure this route exists in your App.jsx, usually /reception-dashboard/billing
      navigate("/reception-dashboard/billing"); 
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="d-flex">
      ...
      >
        ...
        {/* Page Content */}
        <div className="container-fluid pb-5 mt-4 ms-1">
          <h4 className="fw-bold text-primary mb-4 ms-4">Add New Bill</h4>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="d-flex justify-content-end mt-4">
                <button
                  ...
                  // Ensure this points to the correct route in App.jsx
...
export default ReceptionistAddBill;