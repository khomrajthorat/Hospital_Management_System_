...
export default function EncounterDetails({ sidebarCollapsed, toggleSidebar }) {
  ...
  const handleTemplateSelect = async (e) => {
    ...
    try {
      ...
      // Merge or overwrite logic? Usually templates overwrite or append. 
      // Let's append to avoid losing existing data, or maybe ask user?
      // For now, let's append unique items.
      ...
      // For prescriptions, we just append them. 
      // We need to make sure they don't have _id so they are treated as new.
