            ...
            <div className="row mb-4">
              ...
              <div className="col-md-6 mb-3">
                ...
                <select name="clinicId" className="form-select" value={form.clinicId} onChange={handleClinicChange} required>
                  ...
                  {clinics.map(c => (
                    <option key={c._id} value={c._id}>{c.name || c.clinicName || "Unnamed Clinic"}</option>
                  ))}
                </select>
                {clinics.length === 0 && <small className="text-danger">No clinics found.</small>}
              </div>
                   ...
                   <tbody>
                    {form.services.map((svc, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <input className="form-control" value={svc.description} onChange={e => handleServiceChange(index, "description", e.target.value)} placeholder="Additional details..." />
                        </td>
                         <td>
                  ...
                  <div className="card border-0 bg-light p-4">
                     ...
                     <div className="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div className="input-group input-group-sm" style={{width: "150px"}}>
                          <span className="input-group-text">₹</span>
                          <input type="number" name="paidAmount" className="form-control text-end fw-bold" value={form.paidAmount} onChange={handleGenericChange} placeholder="0" />
                        </div>
                     </div>
                     <div className="d-flex justify-content-between mb-3">
