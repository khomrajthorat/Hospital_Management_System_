// src/clinic-dashboard/clinic/PaymentReports.jsx
...
export default function PaymentReports({ sidebarCollapsed = false, toggleSidebar }) {
                          ...
                          <tr key={tx._id}>
                            ...
                            <td>
                              <button
                                ...
                                onClick={() => navigate(`/clinic-dashboard/EditBill/${tx._id}`)}
                                title="View Bill"
                              >
